...
const externalNav = [
	...
	{ name: 'Documentation', href: 'https://github.com/coolio986/ratical/docs/introduction', icon: ArrowTopRightOnSquareIcon },
	{ name: 'Blog', href: 'https://github.com/coolio986/ratical/blog', icon: ArrowTopRightOnSquareIcon },
];

'use client';
/** topmenu.tsx — Next.js App-Router module for the configurator UI. See docs/ARCHITECTURE.md §4. */
						...
						<Menu.MenubarMenu>
							...
							<Menu.MenubarContent onCloseAutoFocus={(e) => e.preventDefault()}>
								...
								<Menu.MenubarItem asChild={true} className="gap-2">
									<Link href="https://github.com/coolio986/ratical/docs/introduction" target="_blank" rel="noreferrer">

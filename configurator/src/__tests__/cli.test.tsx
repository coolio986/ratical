...
describe('Ratical CLI', async () => {
	...
	describe('info command', () => {
		test('should display system information', async () => {
			...
			mockTrpcClient.osVersion.query.mockResolvedValue('Ratical 2.0');
			...
			// Execute command
			await program.parseAsync(['node', 'ratical', 'info']);
	...
	describe('extensions commands', () => {
		test('should list registered extensions', async () => {
			...
			// Execute command
			await program.parseAsync(['node', 'ratical', 'extensions', 'list']);
		...
		test('should register klipper extension', async () => {
			...
			await program.parseAsync(['node', 'ratical', 'extensions', 'register', 'klipper', 'test', './test.py']);
	...
	describe('config commands', () => {
		test('should regenerate configuration', async () => {
			...
			await program.parseAsync(['node', 'ratical', 'config', 'regenerate']);
	...
	describe('doctor command', () => {
		test('should run diagnostic and repair steps', async () => {
			...
			await program.parseAsync(['node', 'ratical', 'doctor']);

...
// Complete map of all available Ratical pin aliases.
export const AllPins = {
	...
	ratical_vaoc_probe_pin: z.string().optional(),
	ratical_vaoc_led_pin: z.string().optional(),
	ratical_vaoc_fan_pin: z.string().optional(),

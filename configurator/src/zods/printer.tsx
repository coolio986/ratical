...
if (process.env.RATICAL_CONFIGURATION_PATH) {
	...
	startsWithServerValidation = path.join(environment.RATICAL_CONFIGURATION_PATH, 'printers');
}
...
export const PrinterDefinition = z
	.object({
		...
		documentationLink: z.string().describe('Link to the Ratical documentation for this printer'),
	...
	.describe('A Ratical supported 3d printer');

...
const GcodeInfoZod = z.object({
	...
	raticalDialectVersion: z.string().optional(),
		...
		if (e instanceof ZodError) {
			...
			echo(
				JSON.stringify({
					...
					code: 'UNKNOWN_ERROR',
					message: `This is likely caused by loading a gcode file that was processed by a legacy version of the Ratical postprocessor.\n\n${formatZodError(e, obj).message}`,
...
export const postprocessor = (program: Command) => {
	program
		.command('postprocess')
		.description('Postprocess a gcode file for Ratical')

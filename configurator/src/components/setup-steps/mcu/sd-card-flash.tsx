 ...
 * 3) Tell the user to follow the flashing instructions at github.com/coolio986/ratical. Poll board serial path in the background. Show tips about flashing.
			...
			<div className="prose mt-4 text-base text-zinc-500 dark:text-zinc-400">
				<ol className="mb-4 list-decimal pl-4">
					...
					<li>
						...
						Ratical is currently powered by your control board or the same power source, please shut it down safely first

					...
					<AnimatedContainer>
						<Disclosure.Panel className="pt-4">
							<dl className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
								...
								{toolhead.getToolboard()?.alternativePT1000Resistor && toolhead.getThermistor() === 'PT1000' && (
									<div className="col-span-full">
										<WarningMessage title="Ratical uses your toolboards alternate pullup resistor setting">
			...
			<div className="p-4 @sm:p-8">
				...
				<div className="space-y-4 text-zinc-700 dark:text-zinc-300">
					...
					<div className="mt-5">
						...
						<a
							href="https://github.com/coolio986/ratical/docs/configuration#initial-configuration"
							target="_blank"
							rel="noreferrer"

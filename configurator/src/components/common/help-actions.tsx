...
export const useHelpActions = () => {
	...
	const onClickFlash = useCallback(() => {
		setFlashModalContent({
			...
			body: 'Please wait while Ratical is flashing your connected boards...',
			dismissText: 'Close',
			dismissVariant: 'primary',
		});
	...
	const onClickSymlink = useCallback(() => {
		setSymlinkModalContent({
			...
			body: 'Please wait while Ratical is symlinking klippy extensions...',
			dismissText: 'Close',
			dismissVariant: 'primary',
		});
	...
	const onClickBeaconFlash = useCallback(
		(e: React.MouseEvent) => {
			setBeaconModalContent({
				...
				body: 'Please wait while Ratical runs the beacon update script...',
				dismissText: 'Close',
			});

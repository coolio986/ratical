/**
 * templates/printers/v-core-4-1-idex.ts — config generator for the 'v-core-4-1-idex' printer.
 *
...
[include Ratical/printers/v-core-4-1-idex/${config.size.x}.cfg]

...
export class MutableGCodeInfo {
	constructor(
		...
		public raticalDialectVersion?: SemVer,
		...
		public raticalMetaFileOffset?: number,
	...
	public serialize(): SerializedGcodeInfo {
		return {
			...
			raticalDialectVersion: this.raticalDialectVersion?.toString(),

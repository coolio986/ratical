#!/usr/bin/env bash
# ratical-kalico-generic — orchestrator
# Layers Ratical (configuration + configurator + extras) onto a stock Raspberry Pi OS
...
echo -e "${RK_GREEN}Open http://<printer-ip>/  (Mainsail) and http://<printer-ip>/configure/  (Ratical Configurator).${RK_NC}"

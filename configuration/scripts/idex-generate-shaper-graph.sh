...
# Use klippy-env for calibrate_shaper.py: Kalico imports klippy → needs cffi (not system python3)
if [ $DISABLE_Y -eq 0 ]
then
	...
	then
		...
		then
			...
			echo "please wait..."
			"${KLIPPER_ENV}"/bin/python "${KLIPPER_DIR}"/scripts/calibrate_shaper.py /tmp/t0_y.csv -o "${outdir}/t0_resonances_y_${DATE}.png"
		fi
		...
		then
			...
			echo "please wait..."
			"${KLIPPER_ENV}"/bin/python "${KLIPPER_DIR}"/scripts/calibrate_shaper.py /tmp/t1_y.csv -o "${outdir}/t1_resonances_y_${DATE}.png"
		fi
	fi
	...
	then
		...
		then
			...
			[ -e "/tmp/t0_copy_y.csv" ] && "${KLIPPER_ENV}"/bin/python "${KLIPPER_DIR}"/scripts/calibrate_shaper.py /tmp/t0_copy_y.csv -o "${outdir}/t0_copy_resonances_y_${DATE}.png"
		fi
		if [ $T1 -eq 1 ]
		then
			...
			[ -e "/tmp/t1_copy_y.csv" ] && "${KLIPPER_ENV}"/bin/python "${KLIPPER_DIR}"/scripts/calibrate_shaper.py /tmp/t1_copy_y.csv -o "${outdir}/t1_copy_resonances_y_${DATE}.png"
		fi
	fi
	...
	then
		...
		then
			...
			[ -e "/tmp/t0_mirror_y.csv" ] && "${KLIPPER_ENV}"/bin/python "${KLIPPER_DIR}"/scripts/calibrate_shaper.py /tmp/t0_mirror_y.csv -o "${outdir}/t0_mirror_resonances_y_${DATE}.png"
		fi
		if [ $T1 -eq 1 ]
		then
			...
			[ -e "/tmp/t1_mirror_y.csv" ] && "${KLIPPER_ENV}"/bin/python "${KLIPPER_DIR}"/scripts/calibrate_shaper.py /tmp/t1_mirror_y.csv -o "${outdir}/t1_mirror_resonances_y_${DATE}.png"
		fi
	fi
fi
...
then
	...
	then
		...
		then
			...
			echo "please wait..."
			"${KLIPPER_ENV}"/bin/python "${KLIPPER_DIR}"/scripts/calibrate_shaper.py /tmp/t0_x.csv -o "${outdir}/t0_resonances_x_${DATE}.png"
		fi
		...
		then
			...
			echo "please wait..."
			"${KLIPPER_ENV}"/bin/python "${KLIPPER_DIR}"/scripts/calibrate_shaper.py /tmp/t1_x.csv -o "${outdir}/t1_resonances_x_${DATE}.png"
		fi
	fi
	...
	then
		...
		then
			...
			[ -e "/tmp/t0_copy_x.csv" ] && "${KLIPPER_ENV}"/bin/python "${KLIPPER_DIR}"/scripts/calibrate_shaper.py /tmp/t0_copy_x.csv -o "${outdir}/t0_copy_resonances_x_${DATE}.png"
		fi
		if [ $T1 -eq 1 ]
		then
			...
			[ -e "/tmp/t1_copy_x.csv" ] && "${KLIPPER_ENV}"/bin/python "${KLIPPER_DIR}"/scripts/calibrate_shaper.py /tmp/t1_copy_x.csv -o "${outdir}/t1_copy_resonances_x_${DATE}.png"
		fi
	fi
	...
	then
		...
		then
			...
			[ -e "/tmp/t0_mirror_x.csv" ] && "${KLIPPER_ENV}"/bin/python "${KLIPPER_DIR}"/scripts/calibrate_shaper.py /tmp/t0_mirror_x.csv -o "${outdir}/t0_mirror_resonances_x_${DATE}.png"
		fi
		if [ $T1 -eq 1 ]
		then
			...
			[ -e "/tmp/t1_mirror_x.csv" ] && "${KLIPPER_ENV}"/bin/python "${KLIPPER_DIR}"/scripts/calibrate_shaper.py /tmp/t1_mirror_x.csv -o "${outdir}/t1_mirror_resonances_x_${DATE}.png"
		fi
	fi
fi